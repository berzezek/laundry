...
def sending_messages(message: Message, custom_phrase: str | None = None):
    messages = {
        ...
        "registration_success": SendingMessages(message).registration_success(custom_phrase),
        ...
        "customer_not_exist": SendingMessages(message).customer_not_exist(custom_phrase),
        ...
        "delivery_for_today": SendingMessages(message).delivery_for_today(custom_phrase),
        "not_delivery_for_today": SendingMessages(message).not_delivery_for_today(custom_phrase),
        "delivery_for_customer_success": SendingMessages(message).delivery_for_customer_success(),
        "delivery_allready_delivered": SendingMessages(message).delivery_allready_delivered(),
    }
    return messages